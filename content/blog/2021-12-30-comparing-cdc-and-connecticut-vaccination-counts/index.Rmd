...
dph_vaccine_total_detail <- read_delim("https://data.ct.gov/api/views/vjim-iz5e/rows.tsv", 
  ...
  mutate(across(c(population, dph_initiated_vaccine, dph_fully_vaccinated, dph_booster), 
                ~ ifelse(is.na(.x), 0, .x))) |> 
...
Department of Public Health with the reports from the CDC. We'll display
the comparison two ways, first with a table and then with a bar chart.
