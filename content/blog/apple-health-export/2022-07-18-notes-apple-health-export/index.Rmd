...
Here are the [slides](RConf2022_health_export_slides.html) for my talk, done as a Quarto presentation.
...
After RStudio (Posit) puts up the videos from the talks, I'll be curious to see whether my mic problems screwed up the beginning of the talk.

The talk basically came off the way I hoped it would.
