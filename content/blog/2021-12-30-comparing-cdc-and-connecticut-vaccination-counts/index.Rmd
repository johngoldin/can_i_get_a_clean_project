...
data](https://www.pewresearch.org/wp-content/uploads/2021/09/FT_21.09.13_benchmarkingPollsVaccination.png?h=640)](https://www.pewresearch.org/fact-tank/2021/09/20/polls-on-covid-19-vaccination-closely-align-with-cdc-data/)
...
immunizations as well). That's why I can see many of my non-COVID
vaccinations in my Connecticut IIS (CT WiZ).

The plan describes a lot of detail about the legal process. It looks
like there are supposed to be [explicit legal
...
Health Laboratories (APHL), presumably under a contract from HHS.
Unfortunately the APHL web site offers no information about the gateway.
