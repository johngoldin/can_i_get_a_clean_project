...
# UConn but I don't know explanation for Canaan.
 p_pops1 <- ggplot(data = vote_vaccinated2 |> 
   ...
   labs(title = "Trump Vote in 2020 and COVID Vaccination Rate",
...
p_pops2 <- ggplot(data = vote_vaccinated2 |> 
 ...
 # geom_smooth(aes(size = pop2020, y = vax_rate2020_over17), colour = "grey", method = "lm") +
   ...
   ylab("xFully Vaccinated") + xlab("Trump vote in 2020") +
   scale_y_continuous(labels=percent) + 
   scale_x_continuous(labels=percent) +
   scale_colour_manual(
...
convert_acs_to_ctdph = tribble(   
  ~acs,            ~ctdph,
 '10 to 14 years', "young",   
 '15 to 17 years', "young",
 '18 and 19 years', "population_18-24",  
 '20 years', "population_18-24",         
 '21 years', "population_18-24",         
 '22 to 24 years' , "population_18-24",  
 '25 to 29 years', "population_25-44",   
 '30 to 34 years', "population_25-44",   
 '35 to 39 years', "population_25-44",   
 '40 to 44 years', "population_25-44",   
 '45 to 49 years', "population_45-64",   
 '5 to 9 years', "population_45-64",     
 '50 to 54 years', "population_45-64",   
 '55 to 59 years', "population_45-64",   
 '60 and 61 years', "population_45-64",  
 '62 to 64 years', "population_45-64",   
 '65 and 66 years', "population_65+",  
 '67 to 69 years', "population_65+",   
 '70 to 74 years' , "population_65+",  
 '75 to 79 years', "population_65+",   
 '80 to 84 years', "population_65+",   
 '85 years and over', "population_65+",
 'Total', "total",           
...
atry <- census_pop |> 
 ...
 census_pop <- left_join(atry, convert_acs_to_ctdph, by = c("census_age" = "acs")) |> 
  group_by(town, ctdph) |> 
  summarise(acs_pop = sum(acs_pop))
```
...
![From Charles Gaba](https://acasignups.net/sites/default/files/styles/inline_default/public/vaxxes_red_blue_every_county_112221_0.jpg?itok=JBx4OW9o){#fig-gaba-chart}
