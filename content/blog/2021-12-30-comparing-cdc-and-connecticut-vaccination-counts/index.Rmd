...
> HHS' [Immunization
> Gateway](https://www.hhs.gov/cto/initiatives/public-health-innovation/immunization-gateway/index.html),
...
Association (AIRA) which has been involved in working out the legal
memoranda of understanding that enable the data exchange. There is a
[training webinar from the summer of
...
Gateway](In%20the%20Share%20component,%20the%20IZ%20Gateway%20will%20recognize%20when%20a%20patient%20is%20vaccinated%20outside%20of%20the%20jurisdiction%20in%20which%20he%20or%20she%20resides%20and%20will%20automatically%20push%20the%20patient’s%20record%20to%20the%20relevant%20IIS.%20By%20opting%20into%20IZ%20Gateway%20Share,%20a%20jurisdiction%20is%20automatically%20choosing%20to%20share%20data,%20when%20relevant,%20with%20all%20participating%20IISs.)
says
...
The component that I have the least information about is the CDC IZ Data
Lake.
...
Systems. It s seems likely that deidentification does not significantly
reduce the number of individual with access to the data.
...
records, the CDC's deidentification step seems like an example of what
[Bruce Schneier](https://en.wikipedia.org/wiki/Bruce_Schneier ) has
coined as [security
theater](https://en.wikipedia.org/wiki/Security_theater). It represents
a visible action related to privacy that doesn't actually do much to
increase privacy. One of a small number CDC staff with access to the
data violating legal and CDC regulations to reveal an individual's
